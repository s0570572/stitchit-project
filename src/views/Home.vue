<template>
  <div id="textbox">
    ...
    <p class="text"><em>Do you create schemes of your own and want to share them? Feel free to do so by clicking on the dark green 'add' button on the upper panel. You will be then guided through a simple uploading procedure.</em></p>
